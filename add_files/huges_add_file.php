...
if (isset($_POST['submit'])) {
  ...
  $stmt = $pdo->prepare('INSERT INTO huge_pets (name, gem_value, demand, value_change, image) VALUES (:name, :gem_value, :demand, :value_change, :image)');
...
<body>
        <?php
            $title_text = 'Добавить новых Хугов!';
        ?>
        <?php
            $check_page = '<a href="../huge_pets.php" class="check-page" target="_blank">Проверить</a>';
        ?>
