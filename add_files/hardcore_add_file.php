...
if (isset($_POST['submit'])) {
  ...
  $stmt = $pdo->prepare('INSERT INTO hardcore_pets (name, gem_value, demand, value_change, image) VALUES (:name, :gem_value, :demand, :value_change, :image)');
  ...
  header('Location: hardcore_add_file.php');
...
<body>  
        <?php
            $title_text = 'Добавить новых Хардкор петов!';
        ?>
                <?php
            $check_page = '<a href="../hardcore_pets.php" class="check-page" target="_blank">Проверить</a>';
        ?>
