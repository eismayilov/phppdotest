...
if (isset($_POST['submit'])) {
  ...
  $stmt = $pdo->prepare('INSERT INTO exclusive_pets (name, gem_value, demand, value_change, image) VALUES (:name, :gem_value, :demand, :value_change, :image)');
  ...
  header('Location: huges_add_file.php');
...
<body>
<?php
            $title_text = 'Добавить новых Экслюзивных петов!';
        ?>
                <?php
            $check_page = '<a href="../exclusive_pets.php" class="check-page" target="_blank">Проверить</a>';
        ?>
