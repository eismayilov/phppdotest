...
$stmt = $pdo->query('SELECT * FROM hardcore_pets');
$hardcore_pets = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<head>
  ...
  <title>Lunar Values - Hardcore Pets - Pet Simulator X Value list</title>
  <meta property="og:site_name" content="Lunar Values - Pet Simulator X Value List">
  <meta property="og:title" content="Lunar Values - Hardcore Pets - Pet Simulator X Value List">
  <meta property="og:url" content="https://petxvalues.com/hardcorepets.html">
  <meta property="og:type" content="website">
  <meta name="description" content="Hardcore Pets - Pet Simulator X Value List. It's our aim to be your source for Pet 
...
x value list • psx values • pet sim x values • pet simulator x values">
  <meta itemprop="name" content="Lunar Values - Hardcore Pets - Pet Simulator X Value List">
  <meta itemprop="url" content="https://petxvalues.com/hardcorepets.html">
  <meta itemprop="description" content="Hardcore Pets - Pet Simulator X Value List. It's our aim to be your source for Pet Simulator X values. We have values for Huge Pets, Exclusives, Mythicals, Legendaries, Glitched Pets, Pog Pets, Hardcore Pets, and even Toy DLC Code Pets!  (January 2023)  pet sim x value list • psx value list • pet simulator">
          ...
          <div class="col-12">
            <div class="hugepets__main">
              <div class="hugepets__links">
                <div class="row">
                  <div class="col-12">
                    <div class="hugepets__main-title langchange title-3" data-key="hardcorePets">
                    </div>
                    <div class="col-12">
                    ...
                    <?php foreach ($hardcore_pets as $hardcores) : ?>
                      <div class="col-md-4">
                        <div class="hugepets__info-main">
                          <div class="hugepets__info">
                            <div class="hugepets__info-img hugepets__info-img1"><img src="uploads/<?php echo $hardcores['image']; ?>" alt="<?php echo $hardcores['name']; ?>"> </div>
                            <div class="hugepets__name" id="search-results"><?php echo $hardcores['name']; ?> </div>
                            <div class="hugepets__gemvalue">
                              <span class="langchange gem" data-key="gemvalue">Gem Value </span><?php echo $hardcores['gem_value']; ?>
                            </div>
                            <div class="hugepets__demand">
                              <span class="langchange demand" data-key="demand">Demand </span><?php echo $hardcores['demand']; ?>
                            </div>
                            <div class="hugepets__vchange">
                              <span class="langchange vchange" data-key="vchange">Value Change </span><?php echo $hardcores['value_change']; ?>
                            </div>
                            <?php
                            // Вывод ссылки на редактирование, если пользователь авторизован
                            if (isset($_SESSION['user_id'])) {
                              echo '<a href="edit_files/huges_edit_file.php?id=' . $hardcores['id'] . '">Edit</a>';
                            }
                            ?>
                            <?php
                            // Вывод ссылки на редактирование, если пользователь авторизован
                            if (isset($_SESSION['user_id'])) {
                              echo '<a href="pages/delete_huge.php?id=' . $hardcores['id'] . '">Delete</a>';
                            }
                            ?>
                          </div>
                        </div>
